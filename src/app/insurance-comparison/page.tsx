...
const InsuranceComparisonPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen ">
      <div className="container-1200 px-4 md:px-6 lg:px-8 py-8 md:py-10">
        <div className="flex flex-col gap-8 md:gap-10">
          {/* Header Section */}
          <div className="flex flex-col gap-2">
            <h1 className="text-navy-blue text-xl md:text-2xl font-semibold tracking-[0.608px]">
              Compare & Choose the Best Insurance for Your Australian Journey
            </h1>
            <p className="text-navy-blue-400 text-sm tracking-[0.2px] capitalize">
              Select your preferences and compare top policies from trusted
              providers. Find the one that fits your budget and coverage needs
              best.
            </p>
          </div>
              ...
              <div className="flex flex-col gap-2 flex-1">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("policyStart", e.target.value)
                    }
              ...
              <div className="flex flex-col gap-2 flex-1">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("policyEnd", e.target.value)
                    }
                    className="w-full px-3 py-2.5 bg-background-1 border border-neutrals-200 rounded text-base text-neutrals-200 focus:outline-none focus:border-navy-blue-300"
                    placeholder="Adults"
                  />
                ...
                >
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div className="w-12 h-12 md:w-16 md:h-12 bg-neutrals-100 rounded flex items-center justify-center">
                      <span className="text-xs text-neutrals-500">Logo</span>
                    </div>
