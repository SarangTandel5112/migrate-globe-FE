                  ...
                  <div className="border-t border-neutrals-100 pt-6">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-neutrals-500 text-base leading-normal">
                        ...
                        EOI based on the information provided. Submitted EOIs
                        are eligible for selection in an invitation round, by a
                        State and Territory government agency or Austrade,
                        depending on the visa subclass(es) selected.
                      </p>
                    </div>
                  </div>
                </div>
