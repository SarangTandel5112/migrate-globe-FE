...
export default function ZoomConsultation() {
  ...
  const isFormValid =
    selectedTime && formData.firstName && formData.lastName && formData.phone;
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          ...
          >
            ...
            >
              <path
                d="M7.99967 13.1667L3.33301 8.49999L7.99967 3.83333"
                stroke="#263773"
                strokeWidth="1.33333"
                strokeLinecap="round"
          ...
          <div className="space-y-2">
            ...
            <p className="font-urbanist text-base text-[#515F8F] leading-6 tracking-[0.2px] capitalize max-w-2xl">
              Lorem ipsum dolor sit amet consectetur. Nunc proin sed dis arcu
              nulla eget lacus.
            </p>
          </div>
        </div>
                    ...
                    >
                      {day && (
                        ...
                        >
                          ...
                          {day >= 14 && day <= 30 && day !== selectedDate && (
