...
export default function Contact() {
  ...
  const [faqItems, setFaqItems] = useState<FAQItem[]>([
    ...
    },
    {
      ...
      answer:
        "Our initial consultation is completely free. You'll only pay for advanced services like documentation support or premium processing packages.",
      isOpen: true,
    },
    {
      id: "3",
  ...
  return (
    <div className="min-h-screen bg-[#F7F8FD]">
      ...
      <div className="flex flex-col lg:flex-row">
                ...
                >
                  ...
                  <defs>
                    <pattern
                      ...
                      height="8"
                    >
                      <circle cx="4" cy="4" r="1" fill="#7D87AB" />
                    </pattern>
                  </defs>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                {offices.slice(0, 3).map((office) => (
                  <div key={office.id} className="bg-[#515F8F] rounded p-4">
        ...
        <div className="lg:w-2/5 bg-white p-10">
      ...
      <div className="py-20 px-4 md:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-8">
            {faqItems.map((item) => (
              <div key={item.id} className="border-b border-[#D3D3D3] pb-4">
                <button
