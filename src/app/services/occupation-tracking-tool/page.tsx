...
const OccupationTrackingPage: React.FC = () => {
  ...
  const StatusIcon = ({ status }: { status: string }) => {
    if (status === "eligible") {
      ...
      return (
        <div className="w-6 h-6 rounded-full border border-red flex items-center justify-center">
  ...
  return (
    <div className="container-1200">
      ...
      <p className="text-base text-navy-blue leading-6 tracking-[0.2px] capitalize pb-8">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 pt-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button className="px-6 py-2 border border-neutrals-300 rounded text-neutrals-700 text-sm font-medium hover:border-neutrals-400 transition-colors bg-white">
            Free assessment
          </button>
          ...
          <div className="bg-white rounded-xl border border-neutrals-100 p-4 md:p-6">
            ...
            <div className="border-t border-neutrals-100 pt-6">
              ...
              <div className="border-t border-neutrals-100 pt-6">
                ...
                {Object.entries(stateEligibility).map(([visaCode, states]) => (
                  <div
                    key={visaCode}
                      ...
                      {Object.entries(states).map(([state, status]) => (
                        <div key={state} className="flex flex-col gap-2">
                          <div className="flex items-center gap-2 px-1 py-1 bg-background-1 border border-neutrals-100 rounded-full">
                            ...
                            <span className="text-neutrals-600 text-base font-normal">
                              {state}
                            </span>
                          </div>
                        </div>
              ...
              <div className="border-t border-neutrals-100 pt-6">
                ...
                <div className="border-t border-neutrals-100 pt-6">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-neutrals-600 text-base leading-normal">
                      An EOI that meets all the requirements for all selected
                      visa subclasses and has all fields completed can be
                      submitted. Once submitted, points are attributed to the
                      EOI based on the information provided. Submitted EOIs are
                      eligible for selection in an invitation round, by a State
                      and Territory government agency or Austrade, depending on
