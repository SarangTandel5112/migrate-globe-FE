        ...
        <div className="flex flex-col items-center gap-10">
          ...
          <div className="w-full">
            ...
            >
              ...
              >
                <path
                  d="M8.00016 13.1667L3.3335 8.5L8.00016 3.83334"
                  stroke="#263773"
                  strokeWidth="1.33333"
                  strokeLinecap="round"
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                      {qualifications.map((qualification) => (
                        <button
                          ...
                          onClick={() =>
                            handleQualificationSelect(qualification.id)
                          }
                          className={`px-4 py-3 rounded-full border transition-all duration-200 ${
                            selectedQualification === qualification.id
                      ...
                      <div className="flex-1 relative">
                        <div className="w-full h-2 bg-[#EDEDED] rounded-full">
                          <div
                            ...
                            style={{ width: `${(workExperience / 30) * 100}%` }}
                          >
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleWorkExperienceChange(parseInt(e.target.value))
                          }
