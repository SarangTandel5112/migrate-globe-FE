            ...
            >
                {features.map((item, i) => (
                    <motion.div
                        ...
                        className={`bg-white hover:bg-gradient-to-r hover:from-[#C7D7FC] hover:to-[#6AF8C5] transition duration-300 p-3 pl-1 pr-2 sm:p-4 rounded-xl shadow-md flex flex-row items-center ${item.span} `}
                    >
