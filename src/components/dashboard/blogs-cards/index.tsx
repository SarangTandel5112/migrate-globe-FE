    ...
    return (
        <div className=" py-16 px-4 sm:px-6 lg:px-20">
            ...
            <section className="mb-16">
                <h2 className="text-center text-2xl md:text-3xl font-semibold text-[#263773] mb-10">From Our Blog</h2>
            ...
            {/* Videos Section */}
            <section>
                <h2 className="text-center text-2xl md:text-3xl font-semibold text-[#263773] mb-10">Watch Our Videos</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {/* {[
                        ...
                        <div key={idx} className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
                            ...
                            <div className="p-4">
                                <h3 className="font-semibold text-base text-[#263773]">
                ...
                <div className="flex justify-center mt-8 space-x-4">
                    ...
                    <button className="w-10 h-10 rounded-full bg-[#263773]" ><MyImage src={RightIcon} alt='left-icon' className='w-3 h-3 m-auto' /></button>
                </div>
            </section>
        </div>
