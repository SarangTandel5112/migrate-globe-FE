...
export default function VisaDetails({
    ...
    //   value: currentVisa?.documentId || "",
    // });
    const visas: visa[] = Array.isArray(visaDetails.visas)
        ? (visaDetails.visas as visa[])
        : [];
                ...
                <div className="flex justify-between items-start">
                  ...
                  {visaDropdownList?.map((o, i) => {
                    ...
                    <Link
                        ...
                        className="bg-navy-blue text-white px-6 py-2 rounded-md text-sm font-medium"
                    >
                        Book a Consultation
                    </Link>
                </div>
