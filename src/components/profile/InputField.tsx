        ...
        {type === "phone" ? (
            <div className="flex flex-row gap-2 w-full">
                ...
                <input
                    ...
                    className="w-full flex-1 px-4 py-2.5 border border-neutrals-200 bg-background-1 rounded text-base text-neutrals-300 font-semibold placeholder:text-neutrals-300"
                    onChange={onChange}
                    {...props}
                />
            </div>
