  ...
  return (
    <>
      <div className="flex gap-10 justify-between items-center px-32 py-8 bg-white shadow-xl md:px-5 md:gap-0">
        ...
        {/* Desktop Navigation */}
        <div className="hidden lg:flex gap-9 items-center self-stretch my-auto text-base font-medium tracking-wide whitespace-nowrap min-w-60 text-stone-500">
        ...
        <div className="hidden lg:flex gap-6 items-center self-stretch my-auto min-w-60">
          <div className="gap-2.5 self-stretch px-6 py-2 my-auto text-sm font-medium tracking-wide text-center text-white bg-indigo-900 rounded-md">
            Book a Consultation
          </div>
          ...
          <div className="gap-2.5 self-stretch px-6 py-2 my-auto text-sm font-medium tracking-wide text-center whitespace-nowrap rounded-md border border-solid border-[color:var(--Neutrals-300,#C0C0C0)] text-zinc-800">
            LogIn
          </div>
        </div>
